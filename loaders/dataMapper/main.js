/*
 * functionality to prepare/map entities objects before passing to the next step
...
/*
 * gather only valid objects where we have valid key-value pairs
 */
...
/*
 * split string into array to get it saved to DB
 */
...
/*
 * Check if we are working with correct JS object
 */
...
/*
 * to check if entity has ID as itrequires by DB model
 */
