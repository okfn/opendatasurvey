<div class="page-header">
  <h1>
    Open Data Index - Frequently Asked Questions
  </h1>
</div>
...
<h2 id="about">About the Open Data Index</h2>

### What's the current state of the Open Data Index?

Right now we are collecting data for the **2013** Index, which focusses on country-level information.  We will be launching the 2013 Index results later in Septmber/October 2013.

After that we will be looking at developing a city-level Index and other enhancements.

**Most of the information in this FAQ applies to the 2013 Index - 2012 ran a little differently.**

### What is the Open Data Index?

The Open Data Index is a year-round ongoing measure of the current state of the open data world; annual snapshots are made by the [Open Knowledge Foundation](http://okfn.org) to showcase the results (the first one later in autumn 2013).  Anyone can contribute at any time to have their input peer-reviewed periodically by a team of 60+ Country Editors.

### How can the results of Open Data Index be used?

The Open Data Index does not aim to create a comprehensive list of open datasets around the world for data users. The Open Data Index seeks to be a tool with which people can ignite conversations with their government by either questioning their performance on the ranking list or by pointing to performance of other governments.

### Who created the Open Data Index?

The purpose of the Index is to provide an accurate and reliable assessment of the state of open (government) data around the world and to present this information in a way that is easy to understand and use.

The Open Data Index was initiated by the [Open Knowledge Foundation](http://okfn.org). It is maintained by the Foundation and its [Open Government Data working group](http://opengovernmentdata.org/) with contributions from many members of the wider community.

### What is the history of the Open Data Index?

The Index was created by the [Open Knowledge Foundation](http://okfn.org) in 2012, and provides a clear measure of available open data - not what is claimed, but what data is actually available and how open it is. The Index is designed by open data experts, including the [Open Knowledge Foundation Open Government Working Group](http://opengovernmentdata.org/), and undergoes a process of peer review and evidence checking to ensure high quality results. An annual announcement of the results creates a focus for debate and review. The Index was launched in 2012 and is undergoing active development to create an Open Data Index in September/October 2013.

<h3 id="whatdatasets">What datasets are included in the Country Index?</h3>

There are 10 datasets considered in the 2013 Index:

{{datasets}}

### Examples of more detailed discussions of the data catagories relating to submissions and review

Issues and challenges for submitters and reviewers are discussed on the [Index discussion list](http://lists.okfn.org/mailman/listinfo/open-data-census). Some of the recurring questions and considerations are listed here:
...
More detailed discussion can be found in [this thread](http://lists.okfn.org/pipermail/open-data-census/2013-October/000221.html) on the Index discussion list.
...
#### See the full Index discussion list archive [here](http://lists.okfn.org/mailman/listinfo/open-data-census).

####

### How reliable is the Open Data Index?

The information in the Index is collected by open data experts around the world including the [Open Knowledge Foundation Open Government Working Group](http://opengovernmentdata.org/). The Index data undergoes a process of peer review and evidence checking to ensure high quality results.


### What about the City Index?

We are currently expanding and improving the Open Data Index and are currently focusing on the Country Index. The City Index is still running on the older system and is due for update later. This means City Index results are not currently being reviewed. More detailed plans for the update will be announced shortly.

### What about the 2012 Index?

Right now we're focussed on the 2013 Index and so the information on the site and in this FAQ mostly is about 2013. In 2012 we looked at fewer datasets and some of the details of methodology were a little different.

### I see you are referring to a Index push or spring in the ‘autumn of 2013’, which can be a bit ambiguous depending on geographic location  - when is that exactly?
...
<h2 id="submit">Submitting information to the Index</h2>

At the moment we are only working on 2013 information.

The index is a survey of the state of open data around the world focusing on the the availability and openness of a <a href="/faq#whatdatasets">specific set of key datasets</a>.
...
If you've got information about a dataset which isn't in the Index yet you can add it!  Anyone can submit new information to the Index.
...
When filling in information about a dataset, there's a list of questions to answer about the availability and openness of the datasets.  The answers then appear in the country overview page for the Index.
...
CSV, XML and XLS would usually count as machine readable, but not always. Consult the [Index discussion list](http://lists.okfn.org/mailman/listinfo/open-data-census) if you’re in doubt.
...
This issue is discussed in more detail in [this thread](http://lists.okfn.org/pipermail/open-data-census/2013-October/000227.html) on the Index discussion list.


### What should I do if different regions/counties/municipalities have different open data situations?

Please email the [Open Data Index discussion list](http://lists.okfn.org/mailman/listinfo/open-data-census) and explain the situation and we'll figure out how to handle the situation. This FAQ will be updated with more info soon!
...
The [main Index page](http://census.okfn.org) points to the current year's index and soon you'll be able to see all the various years of Index results and in the future you'll be able to compare them too.

### I want to help but I'm not sure where to start!

On the Open Data Index, you can see the 10 categories of data that we are focusing on on [the actual site](http://2013.census.okfn.org/country/). Each of the entries for each country has been sent in by citizens of that country, who have simply used Google or other search engines to find out what datasets are available (simply finding the URL) and under which circumstances (are the data openly licensed, can they be downloaded in bulk etc.) - and then made a submission via the form on the site, where they simply fill out a handful of questions and put in the URL for the data. All in all it is a really easy (and fun) task that helps to put a country on the open data map - and it's easy to get started!

You can do some research yourself! Pick a country where the Index shows there is data missing or where there are comments showing that there's uncertainty (perhaps the licence hasn't been specified for example) or a country that you know well.

A targetted search or working with others is most fun and helpful. You could ask on  the [Open Data Index discussion list](http://lists.okfn.org/mailman/listinfo/open-data-census) whether there's a country or area you could help with. Get together with friends, colleagues, your local open data community or [Open Knowledge Foundation local group](http://okfn.org/local) and dig into data on a given topic or for a given country together.

### How can I get more involved?

If you'd like to be more involved you could become a Country Editor for the Index.  Only Index Country Editors can review submissions. If you’d like to become an editor, email the Index team on census@okfn.org
...
### Where can I discuss the Open Data Index with others?

Join the [Open Data Index discussion list](http://lists.okfn.org/mailman/listinfo/open-data-census)

### I'm confused! How can I get help?

There are lots of people who can help on the [Open Data Index discussion list](http://lists.okfn.org/mailman/listinfo/open-data-census) and there are no silly questions, so we encourage you to post there.  You can also privately email the Index Team at the Open Knowledge Foundation on census@okfn.org


<h2 id="results">Understanding the Open Data Index results</h2>

### 2012 versus 2013

You can see the results for the 2012 Index online now, but for the final 2013 results you'll need to wait for our current round of data collection and peer review to finish. We'll be launching 2013 later this autumn... watch this space!

In the meantime you can see the [results in progress for the 2013 Index](http://2013.census.okfn.org/country/) - if these don't look right for your country, [correct them](http://2013.census.okfn.org/contribute/)!

<h3 id="scoring">How does the scoring system work?</h3>

The Open Data Index measures the state of openness of 10 datasets for each country. The overall score for a dataset is based on the response to specific questions with varying weightings - the weighting for each question is listed in the question table above. The overall country score is then calculated from the score on each dataset.
...
If the Open Data Index has caught your interest, there's lots more open data and open government to learn about.
...
If you're a developer or data wrangler and you'd like to help improve the Index site or any other open data tech, join [the Open Knowledge Foundation Labs](http://okfnlabs.org) where you can meet others and collaborate on open source code and other tech projects.
